...
class NetflixFastThreadResult(MeasurementResult):
    ...
    download_rate: typing.Optional[float]
    download_rate_unit: typing.Optional[NetworkUnit]
    download_elapsed_time: typing.Optional[float]
    download_elapsed_time_unit: typing.Optional[TimeUnit]
    city: typing.Optional[str]
    country: typing.Optional[str]
    ...
    latency_elapsed_time: typing.Optional[float]
    latency_elapsed_time_unit: typing.Optional[TimeUnit]
